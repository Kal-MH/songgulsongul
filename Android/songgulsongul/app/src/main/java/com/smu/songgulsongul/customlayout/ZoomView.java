package com.smu.songgulsongul.customlayout;
...
/*    // minimap variables
    ...
    //dot move
    public boolean dot_move = false;
    public void setDotmove(boolean b){ dot_move = b;}
    public boolean getDotmove(){return dot_move;}
